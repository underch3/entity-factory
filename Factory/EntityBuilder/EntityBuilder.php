...
use lkovace18\EntityFactoryBundle\Factory\EntityBuilder\Associations\AbstractRelation;
...
class EntityBuilder
{
     ...
     * @return Data
     */
    private function prepareParams(array $params = []): Data
    {
        $data = new Data();
     ...
     * @return bool
     */
    protected function isAutoGeneratedIdField($field, ClassMetadata $meta): bool
    {
     ...
     */
    private function getRelationHandler($association, ClassMetadata $meta): AbstractRelation
    {
        $mapping = $meta->getAssociationMapping($association);

        switch ($mapping['type']) {
            case ClassMetadataInfo::ONE_TO_ONE:
                return new OneToOne($this->accessor, $this);
                break;
            case ClassMetadataInfo::MANY_TO_ONE:
                return new ManyToOne($this->accessor, $this);
                break;
            case ClassMetadataInfo::ONE_TO_MANY:
                return new OneToMany($this->accessor, $this);
                break;
            case ClassMetadataInfo::MANY_TO_MANY:
                return new ManyToMany($this->accessor, $this);
                break;
            default:
